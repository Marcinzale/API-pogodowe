...
w wybranym mieście w Polsce. Dane pobierane są z API wystawionego przez IMGW.

Console application in Python that shows the weather (time of measurement, temperature, atmospheric pressure)
in a selected city in Poland. The data is downloaded from the API issued by IMGW.
